...
-   Enriching self-study resources
    ...
    -   Enriching self-study rnotes (Zero to hero\[link to resource\])
    -   Use in drop-in
    :::
...
```{=html}
<iframe width="100%" height="630" src="https://numbas.mathcentre.ac.uk/question/125558/integration-solving-separable-differential-equations-radioactive-decay/embed/" title="Numbas"></iframe>
```
:::
:::
...
-   Randomised datasets
-   Walk-thoughts with corresponding cell numbers
:::
...
-   Casual workers
    ...
    -   Experimenting with new formats and designs
    :::
:::
:::
:::
